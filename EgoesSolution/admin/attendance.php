...
<html lang="en">
  <head>
    ...
    <title>Admin Attendance - Prototype</title>
    <link
      ...
      <div class="row">
        <aside class="col-12 col-md-3 col-lg-2 eg-sidebar py-4">
          <nav class="nav flex-column gap-2">
            ...
            <a href="attendance.php" class="eg-sidebar-link active">Attendance</a>
        ...
        <main class="col-12 col-md-9 col-lg-10 py-4">
          <h3 class="mb-4">Weekly Attendance (Prototype)</h3>
          <div class="table-responsive bg-white rounded-3 shadow-sm p-3">
            <table class="table table-bordered align-middle mb-0">
              ...
              <tbody>
                ...
                <!-- Add more static prototype rows as needed -->
              </tbody>
            </table>
          </div>
        </main>
